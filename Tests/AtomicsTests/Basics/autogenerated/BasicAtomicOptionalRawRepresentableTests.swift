...
class BasicAtomicOptionalRawRepresentableTests: XCTestCase {
  ...
  func test_exchange_relaxed() {
    ...
    XCTAssertEqual(
      v.exchange(Hyacinth.bucket, ordering: .relaxed), Hyacinth.bucket)
    XCTAssertEqual(v.load(ordering: .relaxed), Hyacinth.bucket)
  ...
  func test_exchange_acquiring() {
    ...
    XCTAssertEqual(
      v.exchange(Hyacinth.bucket, ordering: .acquiring), Hyacinth.bucket)
    XCTAssertEqual(v.load(ordering: .relaxed), Hyacinth.bucket)
  ...
  func test_exchange_releasing() {
    ...
    XCTAssertEqual(
      v.exchange(Hyacinth.bucket, ordering: .releasing), Hyacinth.bucket)
    XCTAssertEqual(v.load(ordering: .relaxed), Hyacinth.bucket)
  ...
  func test_exchange_acquiringAndReleasing() {
    ...
    XCTAssertEqual(
      v.exchange(Hyacinth.bucket, ordering: .acquiringAndReleasing),
      Hyacinth.bucket)
    XCTAssertEqual(v.load(ordering: .relaxed), Hyacinth.bucket)

    XCTAssertEqual(
      v.exchange(nil, ordering: .acquiringAndReleasing), Hyacinth.bucket)
    XCTAssertEqual(v.load(ordering: .relaxed), nil)
  ...
  func test_exchange_sequentiallyConsistent() {
    ...
    XCTAssertEqual(
      v.exchange(Hyacinth.bucket, ordering: .sequentiallyConsistent),
      Hyacinth.bucket)
    XCTAssertEqual(v.load(ordering: .relaxed), Hyacinth.bucket)

    XCTAssertEqual(
      v.exchange(nil, ordering: .sequentiallyConsistent), Hyacinth.bucket)
    XCTAssertEqual(v.load(ordering: .relaxed), nil)
  ...
  public static var allTests:
    [(String, (BasicAtomicOptionalRawRepresentableTests) -> () -> Void)] = [
