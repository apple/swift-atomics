...
class BasicAtomicBoolTests: XCTestCase {
  ...
  public static var allTests: [(String, (BasicAtomicBoolTests) -> () -> Void)] =
    [
      ...
      (
        "test_loadThenLogicalAnd_acquiringAndReleasing",
        test_loadThenLogicalAnd_acquiringAndReleasing
      ),
      (
        "test_loadThenLogicalAnd_sequentiallyConsistent",
        test_loadThenLogicalAnd_sequentiallyConsistent
      ),
      ...
      (
        "test_loadThenLogicalOr_acquiringAndReleasing",
        test_loadThenLogicalOr_acquiringAndReleasing
      ),
      (
        "test_loadThenLogicalOr_sequentiallyConsistent",
        test_loadThenLogicalOr_sequentiallyConsistent
      ),
      ...
      (
        "test_loadThenLogicalXor_acquiringAndReleasing",
        test_loadThenLogicalXor_acquiringAndReleasing
      ),
      (
        "test_loadThenLogicalXor_sequentiallyConsistent",
        test_loadThenLogicalXor_sequentiallyConsistent
      ),
      ...
      (
        "test_logicalAndThenLoad_acquiringAndReleasing",
        test_logicalAndThenLoad_acquiringAndReleasing
      ),
      (
        "test_logicalAndThenLoad_sequentiallyConsistent",
        test_logicalAndThenLoad_sequentiallyConsistent
      ),
      ...
      (
        "test_logicalOrThenLoad_acquiringAndReleasing",
        test_logicalOrThenLoad_acquiringAndReleasing
      ),
      (
        "test_logicalOrThenLoad_sequentiallyConsistent",
        test_logicalOrThenLoad_sequentiallyConsistent
      ),
      ...
      (
        "test_logicalXorThenLoad_acquiringAndReleasing",
        test_logicalXorThenLoad_acquiringAndReleasing
      ),
      (
        "test_logicalXorThenLoad_sequentiallyConsistent",
        test_logicalXorThenLoad_sequentiallyConsistent
      ),
    ]
  #endif
