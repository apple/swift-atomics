...
class BasicAtomicInt16Tests: XCTestCase {
  ...
  func test_loadThenWrappingIncrement_acquiringAndReleasing() {
    ...
    let old1: Int16 = v.loadThenWrappingIncrement(
      by: b, ordering: .acquiringAndReleasing)
    XCTAssertEqual(old1, a)
    XCTAssertEqual(v.load(ordering: .relaxed), result1)

    let old2: Int16 = v.loadThenWrappingIncrement(
      by: c, ordering: .acquiringAndReleasing)
    XCTAssertEqual(old2, result1)
    XCTAssertEqual(v.load(ordering: .relaxed), result2)
  }
  ...
  func test_loadThenWrappingIncrement_sequentiallyConsistent() {
    ...
    let old1: Int16 = v.loadThenWrappingIncrement(
      by: b, ordering: .sequentiallyConsistent)
    XCTAssertEqual(old1, a)
    XCTAssertEqual(v.load(ordering: .relaxed), result1)

    let old2: Int16 = v.loadThenWrappingIncrement(
      by: c, ordering: .sequentiallyConsistent)
    XCTAssertEqual(old2, result1)
    XCTAssertEqual(v.load(ordering: .relaxed), result2)
  }
  ...
  func test_loadThenWrappingDecrement_acquiringAndReleasing() {
    ...
    let old1: Int16 = v.loadThenWrappingDecrement(
      by: b, ordering: .acquiringAndReleasing)
    XCTAssertEqual(old1, a)
    XCTAssertEqual(v.load(ordering: .relaxed), result1)

    let old2: Int16 = v.loadThenWrappingDecrement(
      by: c, ordering: .acquiringAndReleasing)
    XCTAssertEqual(old2, result1)
    XCTAssertEqual(v.load(ordering: .relaxed), result2)
  }
  ...
  func test_loadThenBitwiseAnd_acquiringAndReleasing() {
    ...
    let old1: Int16 = v.loadThenBitwiseAnd(
      with: b, ordering: .acquiringAndReleasing)
    XCTAssertEqual(old1, a)
    XCTAssertEqual(v.load(ordering: .relaxed), result1)

    let old2: Int16 = v.loadThenBitwiseAnd(
      with: c, ordering: .acquiringAndReleasing)
    XCTAssertEqual(old2, result1)
    XCTAssertEqual(v.load(ordering: .relaxed), result2)
  }
  ...
  func test_loadThenBitwiseAnd_sequentiallyConsistent() {
    ...
    let old1: Int16 = v.loadThenBitwiseAnd(
      with: b, ordering: .sequentiallyConsistent)
    XCTAssertEqual(old1, a)
    XCTAssertEqual(v.load(ordering: .relaxed), result1)

    let old2: Int16 = v.loadThenBitwiseAnd(
      with: c, ordering: .sequentiallyConsistent)
    XCTAssertEqual(old2, result1)
    XCTAssertEqual(v.load(ordering: .relaxed), result2)
  }
  ...
  func test_loadThenBitwiseOr_acquiringAndReleasing() {
    ...
    let old1: Int16 = v.loadThenBitwiseOr(
      with: b, ordering: .acquiringAndReleasing)
    XCTAssertEqual(old1, a)
    XCTAssertEqual(v.load(ordering: .relaxed), result1)

    let old2: Int16 = v.loadThenBitwiseOr(
      with: c, ordering: .acquiringAndReleasing)
    XCTAssertEqual(old2, result1)
    XCTAssertEqual(v.load(ordering: .relaxed), result2)
  }
  ...
  func test_loadThenBitwiseXor_acquiringAndReleasing() {
    ...
    let old1: Int16 = v.loadThenBitwiseXor(
      with: b, ordering: .acquiringAndReleasing)
    XCTAssertEqual(old1, a)
    XCTAssertEqual(v.load(ordering: .relaxed), result1)

    let old2: Int16 = v.loadThenBitwiseXor(
      with: c, ordering: .acquiringAndReleasing)
    XCTAssertEqual(old2, result1)
    XCTAssertEqual(v.load(ordering: .relaxed), result2)
  }
  ...
  func test_wrappingIncrementThenLoad_acquiringAndReleasing() {
    ...
    let new1: Int16 = v.wrappingIncrementThenLoad(
      by: b, ordering: .acquiringAndReleasing)
    XCTAssertEqual(new1, result1)
    XCTAssertEqual(v.load(ordering: .relaxed), result1)

    let new2: Int16 = v.wrappingIncrementThenLoad(
      by: c, ordering: .acquiringAndReleasing)
    XCTAssertEqual(new2, result2)
    XCTAssertEqual(v.load(ordering: .relaxed), result2)
  }
  ...
  func test_wrappingDecrementThenLoad_acquiringAndReleasing() {
    ...
    let new1: Int16 = v.wrappingDecrementThenLoad(
      by: b, ordering: .acquiringAndReleasing)
    XCTAssertEqual(new1, result1)
    XCTAssertEqual(v.load(ordering: .relaxed), result1)

    let new2: Int16 = v.wrappingDecrementThenLoad(
      by: c, ordering: .acquiringAndReleasing)
    XCTAssertEqual(new2, result2)
    XCTAssertEqual(v.load(ordering: .relaxed), result2)
  }
  ...
  func test_bitwiseAndThenLoad_acquiringAndReleasing() {
    ...
    let new1: Int16 = v.bitwiseAndThenLoad(
      with: b, ordering: .acquiringAndReleasing)
    XCTAssertEqual(new1, result1)
    XCTAssertEqual(v.load(ordering: .relaxed), result1)

    let new2: Int16 = v.bitwiseAndThenLoad(
      with: c, ordering: .acquiringAndReleasing)
    XCTAssertEqual(new2, result2)
    XCTAssertEqual(v.load(ordering: .relaxed), result2)
  }
  ...
  func test_bitwiseOrThenLoad_acquiringAndReleasing() {
    ...
    let new1: Int16 = v.bitwiseOrThenLoad(
      with: b, ordering: .acquiringAndReleasing)
    XCTAssertEqual(new1, result1)
    XCTAssertEqual(v.load(ordering: .relaxed), result1)

    let new2: Int16 = v.bitwiseOrThenLoad(
      with: c, ordering: .acquiringAndReleasing)
    XCTAssertEqual(new2, result2)
    XCTAssertEqual(v.load(ordering: .relaxed), result2)
  }
  ...
  func test_bitwiseXorThenLoad_acquiringAndReleasing() {
    ...
    let new1: Int16 = v.bitwiseXorThenLoad(
      with: b, ordering: .acquiringAndReleasing)
    XCTAssertEqual(new1, result1)
    XCTAssertEqual(v.load(ordering: .relaxed), result1)

    let new2: Int16 = v.bitwiseXorThenLoad(
      with: c, ordering: .acquiringAndReleasing)
    XCTAssertEqual(new2, result2)
    XCTAssertEqual(v.load(ordering: .relaxed), result2)
  }
  ...
  public static var allTests:
    [(String, (BasicAtomicInt16Tests) -> () -> Void)] = [
      ...
      (
        "test_loadThenWrappingIncrement_relaxed",
        test_loadThenWrappingIncrement_relaxed
      ),
      (
        "test_loadThenWrappingIncrement_acquiring",
        test_loadThenWrappingIncrement_acquiring
      ),
      (
        "test_loadThenWrappingIncrement_releasing",
        test_loadThenWrappingIncrement_releasing
      ),
      (
        "test_loadThenWrappingIncrement_acquiringAndReleasing",
        test_loadThenWrappingIncrement_acquiringAndReleasing
      ),
      (
        "test_loadThenWrappingIncrement_sequentiallyConsistent",
        test_loadThenWrappingIncrement_sequentiallyConsistent
      ),
      (
        "test_loadThenWrappingDecrement_relaxed",
        test_loadThenWrappingDecrement_relaxed
      ),
      (
        "test_loadThenWrappingDecrement_acquiring",
        test_loadThenWrappingDecrement_acquiring
      ),
      (
        "test_loadThenWrappingDecrement_releasing",
        test_loadThenWrappingDecrement_releasing
      ),
      (
        "test_loadThenWrappingDecrement_acquiringAndReleasing",
        test_loadThenWrappingDecrement_acquiringAndReleasing
      ),
      (
        "test_loadThenWrappingDecrement_sequentiallyConsistent",
        test_loadThenWrappingDecrement_sequentiallyConsistent
      ),
      ...
      (
        "test_loadThenBitwiseAnd_acquiringAndReleasing",
        test_loadThenBitwiseAnd_acquiringAndReleasing
      ),
      (
        "test_loadThenBitwiseAnd_sequentiallyConsistent",
        test_loadThenBitwiseAnd_sequentiallyConsistent
      ),
      ...
      (
        "test_loadThenBitwiseOr_acquiringAndReleasing",
        test_loadThenBitwiseOr_acquiringAndReleasing
      ),
      (
        "test_loadThenBitwiseOr_sequentiallyConsistent",
        test_loadThenBitwiseOr_sequentiallyConsistent
      ),
      ...
      (
        "test_loadThenBitwiseXor_acquiringAndReleasing",
        test_loadThenBitwiseXor_acquiringAndReleasing
      ),
      (
        "test_loadThenBitwiseXor_sequentiallyConsistent",
        test_loadThenBitwiseXor_sequentiallyConsistent
      ),
      (
        "test_wrappingIncrementThenLoad_relaxed",
        test_wrappingIncrementThenLoad_relaxed
      ),
      (
        "test_wrappingIncrementThenLoad_acquiring",
        test_wrappingIncrementThenLoad_acquiring
      ),
      (
        "test_wrappingIncrementThenLoad_releasing",
        test_wrappingIncrementThenLoad_releasing
      ),
      (
        "test_wrappingIncrementThenLoad_acquiringAndReleasing",
        test_wrappingIncrementThenLoad_acquiringAndReleasing
      ),
      (
        "test_wrappingIncrementThenLoad_sequentiallyConsistent",
        test_wrappingIncrementThenLoad_sequentiallyConsistent
      ),
      (
        "test_wrappingDecrementThenLoad_relaxed",
        test_wrappingDecrementThenLoad_relaxed
      ),
      (
        "test_wrappingDecrementThenLoad_acquiring",
        test_wrappingDecrementThenLoad_acquiring
      ),
      (
        "test_wrappingDecrementThenLoad_releasing",
        test_wrappingDecrementThenLoad_releasing
      ),
      (
        "test_wrappingDecrementThenLoad_acquiringAndReleasing",
        test_wrappingDecrementThenLoad_acquiringAndReleasing
      ),
      (
        "test_wrappingDecrementThenLoad_sequentiallyConsistent",
        test_wrappingDecrementThenLoad_sequentiallyConsistent
      ),
      ...
      (
        "test_bitwiseAndThenLoad_acquiringAndReleasing",
        test_bitwiseAndThenLoad_acquiringAndReleasing
      ),
      (
        "test_bitwiseAndThenLoad_sequentiallyConsistent",
        test_bitwiseAndThenLoad_sequentiallyConsistent
      ),
      ...
      (
        "test_bitwiseOrThenLoad_acquiringAndReleasing",
        test_bitwiseOrThenLoad_acquiringAndReleasing
      ),
      (
        "test_bitwiseOrThenLoad_sequentiallyConsistent",
        test_bitwiseOrThenLoad_sequentiallyConsistent
      ),
      ...
      (
        "test_bitwiseXorThenLoad_acquiringAndReleasing",
        test_bitwiseXorThenLoad_acquiringAndReleasing
      ),
      (
        "test_bitwiseXorThenLoad_sequentiallyConsistent",
        test_bitwiseXorThenLoad_sequentiallyConsistent
      ),
    ]
  #endif
