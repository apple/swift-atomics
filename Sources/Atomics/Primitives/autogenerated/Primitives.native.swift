...
extension UnsafeMutablePointer where Pointee == _AtomicInt128Storage {
  ...
  @_alwaysEmitIntoClient
  @_transparent  // Debug performance
  internal func _atomicLoad(ordering: AtomicLoadOrdering)
    -> _AtomicInt128Storage
  {
    switch ordering {
    case .relaxed:
      return _AtomicInt128Storage(
        Builtin.atomicload_monotonic_Int128(_rawValue))
    case .acquiring:
...
@usableFromInline internal typealias _AtomicDoubleWordStorage =
  _AtomicInt128Storage
